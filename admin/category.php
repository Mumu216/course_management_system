  	...
  	<div class="content-wrapper">
	    ...
	    <div class="content-header">
	      <div class="container-fluid">
	        <div class="row mb-2">
	          <div class="col-sm-6">
	            <h1 class="m-0">All Category and Sub Category for the Course</h1>
	          </div>
	          <div class="col-sm-6">
									...
									<div class="card-body">
										<form action="category.php?do=Store" method="POST" enctype="multipart/form-data">
											...
											<div class="form-group">
												...
												<textarea id="description" class="form-control" name="desc"></textarea>
											</div>
								...
								if(isset($_GET['cat_id']))
								{
									...
									while($row = mysqli_fetch_assoc($delData))
									{
									   ...
									   else if( $is_parent == 0)
									   {
										  ...
										  $delAllSubCat = mysqli_query($db, $sql);
										  while($row = mysqli_fetch_assoc($delAllSubCat))
										  {
											 $subCatID    = $row['cat_id'];
